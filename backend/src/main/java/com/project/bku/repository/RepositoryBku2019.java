...
public interface RepositoryBku2019 extends JpaRepository<Bku2019, Long> {
	...
	List<Bku2019> findAllByNpsn(@Param("npsn") Long npsn);
	...
	Page<Bku2019> findAllBySekolahNpsn(Long npsn, Pageable pageable);

	List<Bku2019> findAllBySekolahNpsnAndTanggalBetween(Long npsn, Date start, Date end);
